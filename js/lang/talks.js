    ...
    this.npcs = {
        "charles": {
            "default": {
                "male": [
                    "Привет, дружище!!",
                    "Проблем в пути небыло? Ну и славно. В этой глуши нужно быть осторожным.",
                    "Меня зовут Чарльз, и я секретарь местной Имперской канцелярии. Не спрашивай, за что меня сослали в эту дыру, но я даже начал находить некую прелесть в такой жизни.",
                    "В этом городке ты сможешь отдохнуть от работы и обменяться товарами с другими поселенцами.",
                    "Так как собраны здесь люди самые разные, за порядок отвечаю я, как хоть какой-то представитель власти.",
                    "Итак, со мной можно поговорить о:",
                ],
                "female": [
                    "Доброго дня, юная леди!",
                    "Рад вас видеть. Порой я задумываюсь, что же должна сделать столь прелестная особа, чтобы её отправили в эту дыру, но может, вы приехали в поисках новой жизни... Кхм, давайте о главном.",
                    "Меня зовут Чарльз, и я секретарь местной Имперской канцелярии. Не спрашивайте, за что меня сослали в эту дыру, но я даже начал находить некую прелесть в такой жизни.",
            ...
            "actions": {
                "Set citizenship": "Сообщить о своей принадлежности к одной из фракций.",
                "Get claim": "Получить личный клейм, который дает право на владение землей.",
                // "Get village claim": "Получить деревенский клейм. Стоимость 10 платины.",
            },
        },
        "diego": {
            "default": {
                "male": ["Коты... А вы, не видели котов?"],
            },
            "actions": {
        ...
        "shot": {
            "default": {
                ...
                "female": [
                    "Привет, подруга!",
                    "Меня зовут Шот, и я владелец \"Гарцующего Койота\". У нас есть еда и вода, есть конечно ещё кое что, но девушки редко интересуются подобным, поэтому даже рассказывать не буду. Наш городок довольно неплохой, хоть тут и собрались одни мужланы, да отбросы *хи-хи*. Но ничего, я думаю мы с тобой станем хорошими подругами.",
                ]
            },
            "empire": {
                "male": [
                ...
                "female": [
                    ...
                    "Ну, я надеюсь, я оправдаю ваши ожидания. У меня есть семена на любой вкус. В смысле? Нормальная еда? А что, думаете из этих семян не выйдет ничего путного? У меня и воду можно купить, чтобы их полить *хи-хи*. Шучу конечно. Воду пить можно только тут. Из наших стаканов, да. Да, вот так вот тяжко жить. Можете написать на меня жалобу. Так и напишите: \"Владелица таверны Шот, Конфедератка, дочь Конфедератов, не уважает честных Имперских женщин\"."
                ]
            },
            "confederation": {
                "male": [
        ...
        "boris": {
            ...
            // "actions": {
            //     "Trade indulgence": "Купить индульгенцию (10 золотых +100 кармы)",
            // }
        },
        "bertran": {
            "default": {
        ...
        "vendor": {
            "default": {
                "male": [
                    "Здравствуйте, сударь Не желаете ли приобрести чего-нибудь?.",
                ],
                "female": [
        ...
        "ded-moroz": {
            "default": {
                "male": [
                    "Ну здравствуй!",
                    "Уж пора ёлку нарядить да и стены украсить. Поторопись!",
                ],
            },
        },
        "snegurochka": {
            "default": {
                "male": [
                    "Приветствую тебя.",
                    "Какой чудесный праздник нас ждет. Давай я помогу тебе с украшениями и елочкой.",
                ],
            },
        },
    };
